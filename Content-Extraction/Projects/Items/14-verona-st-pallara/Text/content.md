# Project: 14 Verona St Pallara

- Route: `/projects/14-verona-st-pallara`
- Page title: Aurelia Residence | ARC Builders Project
- Meta description: A beautifully crafted family residence in Pallara featuring modern architectural lines, premium finishes, and spacious open-plan living. Designed to embrace the Queensland lifestyle with seamless indoor-outdoor flow.
- Canonical URL: https://arcbuilders.com.au/projects/14-verona-st-pallara
- Meta keywords: custom home builder Brisbane,builder Logan,custom home builder Rochedale,custom home builder South East Queensland,home builder South East Queensland,Indian Australian home builder,multi-generational home builder,duplex builder Queensland,transparent pricing builder,residential and commercial builder Brisbane,ARC Builders,Pallara, QLD,custom home project,design and build Queensland,custom-home
...
- **alt:** Aurelia Residence in Pallara, QLD - gallery image 1
- **alt:** Aurelia Residence in Pallara, QLD - gallery image 2
- **alt:** Aurelia Residence in Pallara, QLD - gallery image 3
- **alt:** Aurelia Residence in Pallara, QLD - gallery image 4
- **alt:** Aurelia Residence in Pallara, QLD - gallery image 5
- **alt:** Aurelia Residence in Pallara, QLD - gallery image 6
- **alt:** Aurelia Residence in Pallara, QLD - gallery image 7
- **alt:** Aurelia Residence in Pallara, QLD - gallery image 8
- **alt:** Aurelia Residence in Pallara, QLD - gallery image 9
- **alt:** Aurelia Residence in Pallara, QLD - gallery image 10
- **alt:** Aurelia Residence in Pallara, QLD - gallery image 11
