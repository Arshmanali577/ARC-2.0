...
- Route: `/residential`
- Page title: Residential Building Services | ARC Builders
- Meta description: Residential building services by ARC Builders including custom homes, renovations, extensions, granny flats, and duplex projects in South East Queensland.
- Canonical URL: https://arcbuilders.com.au/residential
- Meta keywords: custom home builder Brisbane,builder Logan,custom home builder Rochedale,custom home builder South East Queensland,home builder South East Queensland,Indian Australian home builder,multi-generational home builder,duplex builder Queensland,transparent pricing builder,residential and commercial builder Brisbane,ARC Builders,custom homes Brisbane,home renovations Logan,custom home builder Rochedale,home renovations South East Queensland,extensions Queensland,granny flat builder
...
From custom homes to renovations and extensions, we tailor every project to your unique vision and budget.
...
- granny flat builder
- /projects/8-vineyard-drive-greenbank/hero.webp
- url(/projects/8-vineyard-drive-greenbank/hero.webp)
- mx-auto max-w-7xl px-6 lg:px-8
- )[1]} className=
- > <div className=
- > <Icon size={24} /> </div> <h3 className=
- > {service.title} </h3> <p className=
- > {service.description} </p> </div> </ScrollReveal> ); })} </div> </div> </section> {} <section className=
- > <div className=
- > <ScrollReveal> <p className=
- > Recent Work </p> <h2 className=
- > Residential <span className=
