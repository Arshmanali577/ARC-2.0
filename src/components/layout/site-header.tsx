...
export function SiteHeader() {
  return (
    <header
      className={`header-cast sticky top-0 z-40 flex items-center justify-between gap-5 border-b border-line-soft bg-white/94 py-[18px] backdrop-blur-[10px] nav:py-[22px] ${gutter}`}
    >
