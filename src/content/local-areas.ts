/**
 * The ten service areas, migrated verbatim from the live site's `localAreas`
 * array. The body copy and FAQ wording on each area page is templated from the
 * area name exactly as the live site templates it.
 */
...
/** "Building in {name}" body copy — templated exactly as the live site does. */
export function areaBody(area: LocalArea) {
  return [
...
/** The three FAQs each area page carries, templated from the area name. */
export function areaFaqs(area: LocalArea) {
  return [
    {
